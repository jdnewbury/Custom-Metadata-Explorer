...
def process_custom_metadata_types():
    metadata_folder = 'objects'
    worksheet_name = 'customMetadata'
            ...
            if dir_name.endswith('__mdt'):
                ...
                if os.path.exists(fields_dir_path):
                    ...
                    for file in os.listdir(fields_dir_path):
                        ...
                        #print("API Object Name:", api_object_name)
                        #print(f"Processing custom field file: {file}")
