...
def process_omni_integration_procedures():
    metadata_folder = 'omniIntegrationProcedures'
    ...
    for root_dir, dirs, files in os.walk(processing_path):
        for file in files:
            ...
            ws.append([nameVar, activeVar, uniqueNameVar, typeVar, subTypeVar, versionNumberVar, isIntegrationProcedureVar, isMetadataCacheDisabledVar, isOmniScriptEmbeddableVar, isTestProcedureVar, isWebCompEnabledVar, webComponentKeyVar])
...
process_omni_integration_procedures()
